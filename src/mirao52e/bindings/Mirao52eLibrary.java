...
public class Mirao52eLibrary {
	 ...
	 * Original signature : <code>MroBoolean mro_getVersion(char*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_applyCommand(MroCommand, MroBoolean, int*)</code><br>
	...
	/**
	 * Not documented.<br>
	 * Original signature : <code>MroBoolean mro_applyIoCommand(MroCommand, MroBoolean, int*)</code><br>
	 ...
	 * @see mro_applyStockCommand<br>
	 * @see mro_applySmoothStockCommand<br>
	 * Original signature : <code>MroBoolean mro_applySmoothCommand(MroCommand, MroBoolean, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getLastAppliedCommand(MroCommand, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getLastAppliedCommandDate(MroDate*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_setStockCommand(MroCommand, int, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getStockCommand(MroCommand, int, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_applyStockCommand(int, MroBoolean, int*)</code><br>
	 ...
	 * @see mro_applyCommand<br>
	 * @see mro_applySmoothStockCommand<br>
	 * Original signature : <code>MroBoolean mro_applySmoothStockCommand(int, MroBoolean, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_removeStockCommand(int, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_isStockCommandDefined(int, MroBoolean*, int*)</code><br>
	 ...
	 * @see mro_setStockCommand<br>
	 * Original signature : <code>MroBoolean mro_resetCommandStock(int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getCommandStockSize(int*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getCommandStockMaxSize(int*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_isMonitoringEnabled(MroBoolean*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_setMonitoringEnabled(MroBoolean, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getMirrorTemperature(MroTemperature*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getPowerSupplyTemperature(MroTemperature*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getNegativeCoilsIntensity(MroIntensity*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getPositiveCoilsIntensity(MroIntensity*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getMirrorLockTemperature(MroTemperature*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getPowerSupplyLockTemperature(MroTemperature*, int*)</code><br>
	 ...
	 * @see mro_setMonitoringEnabled<br>
	 * @see mro_getNegativeCoilsIntensity<br>
	 * Original signature : <code>MroBoolean mro_getNegativeCoilsLockIntensity(MroIntensity*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_getPositiveCoilsLockIntensity(MroIntensity*, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_isLocked(MroBoolean*, int*)</code><br>
	 ...
	 * <br>
	 * @see mro_setMonitoringEnabled<br>
	 * Original signature : <code>MroBoolean mro_isConnected(MroBoolean*, int*)</code><br>
	 ...
	 * <br>
	 * @see mro_setMonitoringEnabled<br>
	 * Original signature : <code>MroBoolean mro_registerCallback(MroRegisterCallbackCallbackCallback*, int*)</code><br>
	 ...
	 * <br>
	 * @see mro_registerCallback<br>
	 * Original signature : <code>MroBoolean mro_unregisterCallback(int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_writeCommandFile(MroCommand, char*, MroBoolean, int*)</code><br>
	 ...
	 * Original signature : <code>MroBoolean mro_readCommandFile(char*, MroCommand, int*)</code><br>
